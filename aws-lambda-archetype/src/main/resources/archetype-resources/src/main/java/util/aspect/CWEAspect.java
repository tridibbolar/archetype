...
@Aspect
public class CWEAspect {
	static final Logger LOG = LogManager.getLogger(CWEAspect.class);
	//Useful link
    ...
    //com.tcg.ua.cwe.lambda.config.YourClass.yourMethodBefore(..) = PackageName . ClassName . methodName (parameters)
    //@Around("execution (!private !void com.tcg.ua.cwe.lambda.config.GEEDBConfigurationFunctionHandler.*(..))")
	...
	/*@Before("execution (* com.tcg.ua.cwe.lambda.config.GEEDBConfigurationFunctionHandler.handleRequest(..))")
    ...
    //com.tcg.ua.cwe.lambda.config.YourClass.yourMethodBefore(..) = PackageName . ClassName . methodName (parameters)
    /*@After("execution (public JSONObject com.tcg.ua.cwe.lambda.config.CWEDBConfigurationFunctionHandler.handleRequest(..))")
    ...
    //com.tcg.ua.cwe.lambda.config.YourClass.yourMethod*(..) = PackageName . ClassName . * (parameters)
    //Where the "*" will catch any method name
    //JointPoint = the reference of the call to the method
    /*@After("execution ( * com.tcg.ua.cwe.lambda.config.YourClass.*(..))")
